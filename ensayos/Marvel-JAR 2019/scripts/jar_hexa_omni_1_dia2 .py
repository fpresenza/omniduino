...
if __name__ == '__main__':
    ...
    try:
        ...
        marvel_omni_file = "omni_20190604_12:45:42_hexa_omni_1.txt"
        opti_file = "Omni_solo-2019-05-24 03.32.36 PM.csv"
    ...
    #     if (marvel.omni.t[i] > 55.0 and marvel.omni.t[i] < 60.0):
    ...
    #     if (opti.omni.t[i] > 55.0 and opti.omni.t[i] < 60.0):
